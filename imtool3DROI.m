...
classdef imtool3DROI < handle
    ...
    properties (SetObservable = true)
        ...
        markerColor = 'r';
        visible = true;
        textVisible = true; % This property is subordinate to visible (i.e., if visible is false, the text will not
                            % be visible even if textVisible is true)
    end
            ...
            for(i = 1:length(graphicsHandles))
                ...
                switch(class(graphicsHandles(i)))
                    case 'matlab.graphics.chart.primitive.Line'
                        set(graphicsHandles(i), 'Color', ROI.lineColor, 'MarkerFaceColor', ROI.markerColor, ...
                            'MarkerEdgeColor', ROI.markerColor, 'Visible', str);
